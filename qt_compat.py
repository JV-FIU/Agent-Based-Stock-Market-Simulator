...
#Possible fix in https://github.com/matplotlib/matplotlib/pull/24158/files
def _setup_pyqt5plus():
    global QtCore, QtGui, QtWidgets, __version__                #NOTE: Edited to fix TypeError raised by backend_qt - Jorge V.
    global _isdeleted, _getSaveFileName, _to_int                #NOTE: Edited to fix TypeError raised by backend_qt - Jorge V.
                                                                #NOTE: Added '_to_int' to fix TypeError raised by backend_qt - Jorge V.
    if QT_API == QT_API_PYQT6:
        ...
        _to_int = operator.attrgetter('value')                  #NOTE: Added to fix TypeError raised by backend_qt - Jorge V.
    elif QT_API == QT_API_PYSIDE6:
        from PySide6 import QtCore, QtGui, QtWidgets, __version__
        import shiboken6
        def _isdeleted(obj): return not shiboken6.isValid(obj)        
        if parse_version(__version__) >= parse_version('6.4'):  #NOTE: Added to fix TypeError raised by backend_qt - Jorge V.
            _to_int = operator.attrgetter('value')              #NOTE: Added to fix TypeError raised by backend_qt - Jorge V.
        else:                                                   #NOTE: Added to fix TypeError raised by backend_qt - Jorge V.
            _to_int = int                                       #NOTE: Added to fix TypeError raised by backend_qt - Jorge V.
        ...
        #import shiboken2                                       #NOTE: Commented to attempt to fix TypeError raised by backend_qt - Jorge V.
        try:                                                    #NOTE: Added to fix TypeError raised by backend_qt - Jorge V.
            from PySide2 import shiboken2                       #NOTE: Added to fix TypeError raised by backend_qt - Jorge V.
        except ImportError:                                     #NOTE: Added to fix TypeError raised by backend_qt - Jorge V.
            import shiboken2                                    #NOTE: Added to fix TypeError raised by backend_qt - Jorge V.
...
#_to_int = operator.attrgetter("value") if QT_API == "PyQt6" else int   #NOTE: Commented to attempt to fix TypeError raised by backend_qt - Jorge V.
